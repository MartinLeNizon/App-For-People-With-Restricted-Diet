...
def main():
    ...
    for image in range(1, 21):  # 
        ...
        for allergen in range(0, 14):
            prediction_array.append(predict(f"feature_engineering_dataset/enhanced_data/{image:03d}.jpg", allergen))    # First arg: image path; Second: allergen (0: gluten, 1: eggs...). See allergens line 6.
